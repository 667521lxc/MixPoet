...
hparams = HParams(
    ...
    vocab_path="D:/MixPoet-master/corpus/vocab.pickle",#"/kaggle/input/mixpoet-code/MixPoet-master/corpus/vocab.pickle", #"../corpus/vocab.pickle",    
    #在kaggle上运行时，参照本行的注释写法
    ivocab_path="D:/MixPoet-master/corpus/ivocab.pickle", #"../corpus/ivocab.pickle",
    train_data="D:/MixPoet-master/corpus/semi_train.pickle", #"../corpus/semi_train.pickle",
    valid_data="D:/MixPoet-master/corpus/semi_valid.pickle", #"../corpus/semi_valid.pickle",
    model_dir="D:/MixPoet-master/model_ckpt_mixfine_3e.tar",#"/kaggle/working/", #"../checkpoint/",
    ...
    train_log_path="/kaggle/working/mix_train_log.txt",
    valid_log_path="/kaggle/working/mix_valid_log.txt",
    fig_log_path="/kaggle/working/",
    ...
    dae_save_epoches=2,
    dae_train_log_path="/kaggle/working/dae_train_log.txt",
    dae_valid_log_path="/kaggle/working/dae_valid_log.txt",
    #------------------------------------------
    ...
    cl_save_epoches=2,
    cl_train_log_path="/kaggle/working/cl_train_log.txt",
    cl_valid_log_path="/kaggle/working/cl_valid_log.txt",
)
